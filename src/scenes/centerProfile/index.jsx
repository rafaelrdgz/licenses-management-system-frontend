...
import {updateClient} from "../../apis/ClientAPI.js";
...
const CenterProfile = () => {
  ...
  const handleExportPdf = () => {
    ...
    const fields = [{label: "Nombre:", value: info.name}, {
  ...
  return (<Box m="20px">
    ...
    >
      ...
      {!disableEdit && (<IconButton
        sx={{
          position: "absolute", marginLeft: "150px", cursor: "pointer",
        }}
        component="label"
      >
        <EditOutlinedIcon/>
      ...
      {({
        ...
        >
          ...
          {!disableEdit && (<Button
            ...
            onClick={() => {
              console.log(errors);
              if (Object.keys(errors).length === 0) handleFormSubmit(values);
            }}
          >
            Guardar
          </Button>)}
